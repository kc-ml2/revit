...
def get_rot_mnist_loaders(root="./data", batch_size=64, num_workers=8, pin_memory=True):
    ...
    train_dataset = MNIST_rot(root, train=True, download=True, transform=transform)
    test_dataset = MNIST_rot(root, train=False, download=True, transform=transform)
